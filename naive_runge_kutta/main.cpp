...
int main () {
    ...
    //y(x_0) =y_0;
    double y0 = 0;
    std::cout << "Runge-kutta 2nd order: " << runge_kutta_2nd_order_1f_(x_begin, x_end, y0, N, f_shtrih) <<std::endl;
    std::cout << "Strict solution: " << f_sol(x_end) <<std::endl;
    
    std::cout << "-----------------" << std::endl;
    std::cout << "Runge-kutta 4rh order: " << runge_kutta_4rh_order_1f_(x_begin, x_end, y0, N, f_shtrih) <<std::endl;
    std::cout << "Strict solution: " << f_sol(x_end) <<std::endl;
